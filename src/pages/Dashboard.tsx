        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <aside className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="mt-6 text-center">
              <button className="px-4 py-2 rounded-full bg-gradient-to-r from-purple-600 to-blue-500 text-white text-sm hover:opacity-95">Ver oportunidades completas</button>
            </div>
          </aside>
        </section>
      </main>
